...
wellDataSelectedColumnsFromTables = dict(compliance='INSP_ID, INSPECTION_DATE, INSPECTION_RESULT_DESC, INSP_COMMENT, VIOLATION_ID',
                                         production='PERIOD_ID, GAS_QUANTITY_MCF, GAS_PRODUCTION_DAYS, CONDENSATE_QUANTITY_BBL, CONDENSATE_PRODUCTION_DAYS, OIL_QUANTITY_BBL, OIL_PRODUCTION_DAYS',
                                         waste='PERIOD_ID, WASTE_TYPE, WASTE_QUANTITY, UNITS, DISPOSAL_METHOD, WASTE_FACILITY_PERMIT_ID, WASTE_FACILITY_NAME, FACILITY_CITY, FACILITY_STATE')
...
wellDataProperColumnNames = dict(inspection=['INSPECTION ID', 'DATE', 'DESCRIPTION', 'COMMENT', 'VIOLATION ID'],
                                 production=['PERIOD', 'GAS QUANTITY', 'GAS PRODUCTION DAYS', 'CONDENSATE QUANTITY', 'CONDENSATE PRODUCTION DAYS', 'OIL QUANTITY', 'OIL PRODUCTION DAYS'],
                                 waste=['PERIOD', 'TYPE', 'QUANTITY', 'UNITS', 'DISPOSAL METHOD', 'WASTE FACILITY PERMIT ID', 'WASTE FACILITY NAME', 'FACILITY CITY', 'FACILITY STATE'])
